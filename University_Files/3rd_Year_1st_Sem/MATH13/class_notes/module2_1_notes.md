Frequency in Grouped Data without class- Ilang beses umulit ang isang element sa isang grouped data
...
1. Given an unsorted groiped data, use the Sturges' formula. Round i to whole number

i= 1+ [(log n)/(log 2)]

n= sample size

2. Determine the Range- Highest-Lowest data.

3. Divide range to number of class interval to obtain class width.

c= range/i wherein c=class width.

4. List the lower class limit of the lowest clas sinterval then add class width.

5. List the upper class limit.

6. Tally the frequencies for each class interval and sum them up based on the ungrouped data.
